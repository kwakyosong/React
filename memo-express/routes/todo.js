...
exports.todoListRouter = function(req, res){	// ToDo 목록 가져오기
...
exports.todoAddRouter = function(req, res){	// 새로운 ToDo 항목 추가하기
...
exports.todoCompleteRouter = function(req, res){	// 선택한 ToDo 항목 완료하기
	fs.readFile('./todo_list.json', {
		'encoding': 'utf8'
	}, function (err, data) {
		data = JSON.parse(data);
        ...
        data.list[req.body.index].complete = !data.list[req.body.index].complete;
...
exports.todoDelRouter = function(req, res){	// 선택한 ToDo 항목 삭제하기
	fs.readFile('./todo_list.json', {
		'encoding': 'utf8'
	}, function (err, data) {
		data = JSON.parse(data);
